...
import {useCreateTransportation} from "@/store/server/transportations/mutation.tsx";
...
const CreateTransportation = () => {
    ...
    return (
        <div className=" px-5 pt-5">
            ...
            (Place to create transportation)
          </span>
                </p>
            </div>
            <div className=" mt-5 p-5 bg-white">
                <Form {...form}>
                    <form
                        onSubmit={form.handleSubmit((val) => createTransportation.mutate(val))}
                        id="form-data"
                        name="form-data"
                        className=" space-y-5"
                        action=""
